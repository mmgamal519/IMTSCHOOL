...
// avoid magic numbers in decleration
//use standard naming convention even for arrguments

void DIO_VidSetPinDirection	( u8 LOC_u8Port, u8 LOC_u8Pin, u8 LOC_u8State);
// function returen void to set pin value 
...
u8 	 DIO_u8GitPinValue		( u8 LOC_u8Port, u8 LOC_u8Pin, u8 LOC_u8Value);
